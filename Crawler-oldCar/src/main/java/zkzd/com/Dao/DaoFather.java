package zkzd.com.Dao;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import zkzd.com.Until.ReadFileUtil;
...
public class DaoFather {
    ...
    public DaoFather(int choseDB, int choseTable) {
        ...
        String content = readFileUtil.MethodReadFile("D:\\JavaWorkPlace\\Zedata-data-Crawler\\Crawler-oldCar\\src\\main\\resources\\", "DBConfig.json");
...
//                    获取值
    ...
    public ArrayList<Object> Method_FindIsDown() {
        ArrayList<Object> BeanLsit = new ArrayList<>();
        try {
            String sql = "Select * from " + this.TableName + " where C_downState = '是' ";
            MethodCreateSomeObject();
            ResultSet resultSet = statement.executeQuery(sql);
